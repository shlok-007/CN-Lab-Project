...
class TorrentNetwork:
    ...
    def perform_choke_unchoke(self, current_step):
        ...
        for peer in self.peers:
            ...
            peer.prev_uploaded = peer.uploaded_pieces
            peer.prev_downloaded = peer.downloaded_pieces
    ...
    def print_summary(self):
        ...
        print(self.w_downloaded,self.w_uploaded,self.w_uploadrate)
